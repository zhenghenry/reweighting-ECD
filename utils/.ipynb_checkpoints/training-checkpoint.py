...
class create_model(pl.LightningModule):
    def __init__(self, d, loss_fun, output, optimizer, learning_rate, eta, F0, nu):
...
class create_model_layer(pl.LightningModule):
    def __init__(self, hidden_layers, loss_fun, output, optimizer, learning_rate, eta, F0, nu):
        super(create_model_layer, self).__init__()
        self.d = 1
        self.p = 0.05
        self.optimizer = optimizer
        self.linear_in = nn.Linear(self.d, 64)
        self.linear_out = nn.Linear(64, self.d)
